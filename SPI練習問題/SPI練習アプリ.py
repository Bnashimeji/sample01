...
class SPIApp:
    ...
    def __init__(self, master):
        ...
        #self.choices_scrollbar = tk.Scrollbar(self.right_frame)
        #self.choices_scrollbar.config(command=self.choices.yview)

        #self.choices.config(yscrollcommand=self.choices_scrollbar.set)
        ...
        self.choices_scrollbar.pack(side=tk.RIGHT, fill=tk.Y)
